...
<div class="breadcrumb mb-4 gradiente sombrita rounded-2" >
    <h5 class="breadcrumb-item active text-white m-3">Categorias</h5>
</div> 

<button class="btn btn-primary mb-3" type="button"  onclick ="frmCategoria();">Nuevo <i class ="fas fa-plus"></i></button>
