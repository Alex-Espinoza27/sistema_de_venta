...
<div class="breadcrumb mb-4 gradiente sombrita rounded-2" >
    <h5 class="breadcrumb-item active m-3 text-white">Medidas</h5>
</div> 

<button class="btn btn-primary mb-3" type="button"  onclick ="frmMedida();">Nuevo <i class ="fas fa-plus"></i></button>
